...
{   // introduction
    ...
    Console.WriteLine("* You can't remember when you last had memory.. Or even thoughts for that matter. Odd!"); Console.ReadLine();
}
else
{   // skip
    Console.WriteLine("* Scanning your surroundings' for losers anyways. You're tough boned.");
}   // witch intro
...
Console.WriteLine("*A shrill, female voice startles you from behind. You frantically swing behind you.\n\"You're quite far out for someone like yourself, little guy. Haven't seen one of you out here, adventurers dont treat your kind very well.\""); Console.ReadLine();
...
Console.WriteLine("<<You got a coin pouch! (20C)>>"); Console.ReadLine();
...
int coin = 20;
Console.WriteLine("\"Give that to the merchant if you see em'. Tell him I said hi, and to stop being such a bucket-head on his 'sides' debate. I'm not fighting anymore.\""); Console.ReadLine();
...
{
    Console.WriteLine("* You couldn't think of anything to do, so you just sat there after that whole thing. She leaves."); Console.ReadLine();
    ...
    Console.WriteLine("You lost "+2+" coins. You now have "+(coin)+"C.");
}